        ...
        <div class="db-content-list">
          <el-col :span="12">
            ...
            <el-form-item label="dataSource:">
              <el-select v-model="sourceValue" size="mini" placeholder="请选择">
                <el-option
          ...
          <el-col :span="12">
            ...
            <el-form-item label="serverName:">
              <el-input v-model="serverValue" size="mini" @input="serverChange" placeholder="请输入服务名"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <!-- <span>账号:</span> -->
            <el-form-item label="账号:">
              <el-input v-model="username" size="mini" placeholder="请输入账号"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <!-- <span>密码:</span> -->
            <el-form-item label="密码:">
              <el-input v-model="password" size="mini" placeholder="请输入密码"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <!-- <span>baseName:</span> -->
            <el-form-item label="baseName:">
              <el-select v-model="baseValue" size="mini" placeholder="请选择">
                <el-option
